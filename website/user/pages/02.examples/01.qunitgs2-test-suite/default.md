...
Take a look at the [QUnitGS2-Test source](https://github.com/artofthesmart/QUnitGS2-Test)
...
The companion test repository includes an opt-in `?suite=exceptions` route.
...
[test instructions](https://github.com/artofthesmart/QUnitGS2-Test/blob/master/test/README.md)
...
totals, subsequent tests, and collapse/filter controls. The companion repository
also has a local verifier that calls its real consumer entry points against a
local library checkout.
